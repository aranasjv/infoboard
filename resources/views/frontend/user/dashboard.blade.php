    ...
    <div class="row" >
        ...
        <div class="col-xs-12">
            ...
            <div class="panel panel-default" >
                <div class="panel-heading" style="background-color: #128CA8"> <font color="white">{{ trans('navs.frontend.dashboard') }}</font></div>

                <div class="panel-body" style="background-color: #AED4E6">
