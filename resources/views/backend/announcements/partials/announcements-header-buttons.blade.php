<!--Action Button-->
@if( Active::checkUriPattern( 'admin/announcements' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.announcements.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.announcements.all' ) }}
            </a>
        </li>
        @permission( 'create-announcement' )
            <li>
                <a href="{{ route( 'admin.announcements.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.announcements.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
