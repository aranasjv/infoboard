    ...
    <script>
        ...
        $(function() {
            var dataTable = $('#events-table').dataTable({
                ...
                columns: [
                    {data: 'title', name: '{{config('module.events.table')}}.title'},
                    {data: 'start_date', name: '{{config('module.events.table')}}.start_date'},
                    {data: 'end_date', name: '{{config('module.events.table')}}.end_date'},
